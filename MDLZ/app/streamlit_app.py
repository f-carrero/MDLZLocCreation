...
def get_platform_client():
    ...
    api_key = os.environ.get("WILIOT_API_KEY", st.secrets.get("WILIOT_API_KEY", ""))
    owner_id = os.environ.get("WILIOT_OWNER_ID", st.secrets.get("WILIOT_OWNER_ID", ""))
...
def email_results(results_df, location_type):
    ...
    smtp_host = os.environ.get("SMTP_HOST", st.secrets.get("SMTP_HOST", ""))
    smtp_port = os.environ.get("SMTP_PORT", st.secrets.get("SMTP_PORT", "587"))
    smtp_username = os.environ.get("SMTP_USERNAME", st.secrets.get("SMTP_USERNAME", ""))
    smtp_password = os.environ.get("SMTP_PASSWORD", st.secrets.get("SMTP_PASSWORD", ""))
    sender = os.environ.get("SMTP_SENDER", st.secrets.get("SMTP_SENDER", ""))
    recipient = os.environ.get("RESULTS_RECIPIENT", st.secrets.get("RESULTS_RECIPIENT", ""))
