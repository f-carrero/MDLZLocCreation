...
def validate_trailer_data(df, dc_locations_df):
    ...
    # Names with invalid characters (only letters, numbers, dashes, and spaces allowed)
    valid_names = df["name"].astype(str).str.strip()
    ...
    if invalid_char_count:
        ...
        errors.append(f"{invalid_char_count} names contain invalid characters (only letters, numbers, dashes, and spaces allowed) — will be skipped: {bad_names}")
